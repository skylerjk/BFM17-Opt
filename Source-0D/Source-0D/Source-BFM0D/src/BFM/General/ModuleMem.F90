...
!        O3h                                   Dissolved Inorganic Carbon      mmol eq/m3
       ...
       integer,public,pointer,dimension(:)  :: D2STATEOBC_BEN
        ...
        integer,parameter,public  ::NO_D3_BOX_DIAGNOSS = 90

        integer,parameter,public  ::NO_D2_BOX_DIAGNOSS = 161

        integer,parameter,public  ::NO_D3_BOX_FLUX     = 16
...
! ELiPPY(iiP4)                                          Large Phytoplankton            W/m2
    ...
    ppsediR2=29, ppsediR6=30, ppxEPS=31, ppABIO_eps=32
        ...
        integer,public ::           ppsunPPY(iiPhytoPlankton), &
    ppqpcPPY(iiPhytoPlankton), ppqncPPY(iiPhytoPlankton), &
    ppqscPPY(iiPhytoPlankton), ppqlcPPY(iiPhytoPlankton), &
    ...
    ppsediMEZ(iiMesoZooPlankton), ppeiPPY(iiPhytoPlankton), &
   ...
   real(RLEN),public,dimension(:),pointer  :: ETW, ESW, ERHO, EIR, ESS, EPR, &
    ...
    flN4N3n, sediR2, sediR6, xEPS, ABIO_eps
        ...
        real(RLEN),public,dimension(:,:),pointer  :: sunPPY, qpcPPY, qncPPY, &
    qscPPY, qlcPPY, qpcMEZ, qncMEZ, qpcMIZ, qncMIZ, qpcOMT, qncOMT, qscOMT, &
    qpcPBA, qncPBA, sediPPY, sediMIZ, sediMEZ, eiPPY, ELiPPY
