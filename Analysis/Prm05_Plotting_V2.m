...
FileLoc = '../PE-Runs/OSSE-1D-51Prm-17StVr-OpQNwNorm-dt400-PrmSetAll-10percpert-Norm_RefSTD-GS1e-5-CC1e-10/PEOutput.dat';
...
scatter([1:length(obj_val)],obj_val,[45],clrgrd,'filled'), hold on

ttl = title('Prm Set All OSSE: Objective Function Evaluations',Opt_Text); ttl.Color = TxtClr;
...
ttl = title('Prm Set All OSSE: Difference in Normalized Parameter Values',Opt_Text);
